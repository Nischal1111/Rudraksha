        ...
        <div className="relative h-full max-w-7xl mx-auto px-4 flex items-center">
          <div className="max-w-3xl">
            ...
            <p className="text-lg md:text-xl text-gray-100 mb-8">
              Explore our curated collection of authentic Rudraksha malas, carefully sourced from sacred locations across Nepal and Indonesia.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="flex flex-col md:flex-row gap-8">
          ...
          <div className="md:w-3/4">
            ...
            {/* Products Grid */}
            <div>
              <h1 className={`text-primary font-bold text-4xl mb-8 ${josefin.className}`}>Our Rudraksha Mala Collection</h1>
